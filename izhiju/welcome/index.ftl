...
<div class="wrapper">
    <div class="content">
        <div class="logo">
                <img src="welcome-content/keycloak_logo.png" alt="爱智居" border="0" />
        </div>
        <h1>Welcome to izhiju.cn</h1>
        ...
        <p><a href="http://www.izhiju.cn">智居首页</a> | <a href="admin/">Administration Console</a> </p>
